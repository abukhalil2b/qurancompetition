        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2 space-y-4">
                ...
                "
                        ...
                        {{-- Judges List - Added Padding Container --}}
                        <div class="p-4">
                                    ...
                                    <div
                                        ...
                                        <div class="flex items-center gap-2">
                                            <a href="{{ route('user.show', $judge->id) }}"
                                                ...
                                                {{-- Leader Icon OR Avatar --}}
                                                <div class="relative">
                                                    <div
                                                        class="flex-shrink-0 w-9 h-9 rounded-full flex items-center justify-center transition-colors
                                            {{ $judge->pivot->is_judge_leader ? 'bg-amber-500 text-white' : 'bg-gray-100 text-gray-400 group-hover:bg-blue-100 group-hover:text-blue-600' }}">
                                                ...
                                                <div>
                                                    <p
                                                        class="text-sm font-bold transition-colors {{ $judge->pivot->is_judge_leader ? 'text-amber-900' : 'text-gray-700 group-hover:text-blue-700' }}">
                                                        {{ $judge->name }}
                                                    </p>
                                        ...
                                        <div class="flex items-center gap-1">
                                            ...
                                            {{-- Only show "Set Leader" button if the user's role is exactly 'judge' and they aren't already leader --}}
                                            @if ($judge->pivot->role === 'judge')
                                                @if (!$judge->pivot->is_judge_leader)
                                            ...
                                            {{-- Remove Judge Action (Available for all roles) --}}
